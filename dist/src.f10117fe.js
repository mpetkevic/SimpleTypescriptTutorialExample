...
function () {
  ...
  Model.prototype.fetch = function () {
    ...
    if (typeof id !== 'number') {
      throw new Error('Cannot fetch withuot an id');
    }
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Atrributes_1.Atrributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Atrributes":"src/models/Atrributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
